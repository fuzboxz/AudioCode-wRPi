...
public class CodeTask3_6 extends Application implements BeadsChecker.BeadsCheckable {
    ...
    public void task(AudioContext ac, StringBuffer stringBuffer, Object... objects) {
        ...
        WavePlayer mod2oscillator = new WavePlayer(ac, baseFreq * mod2FreqMult, Buffer.SINE);
        WavePlayer mod1oscillator = new WavePlayer(ac, baseFreq * mod1FreqMult + mod2oscillator.getFrequency() * mod2ModStrength, Buffer.SINE);
        WavePlayer carrier = new WavePlayer(ac, baseFreq + mod1oscillator.getFrequency() * mod1ModStrength, Buffer.SINE);

        ac.out.addDependent(mod2oscillator);
        ac.out.addDependent(mod1oscillator);
